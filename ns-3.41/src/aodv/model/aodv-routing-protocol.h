...
class RoutingProtocol : public Ipv4RoutingProtocol
{
  public:
    ...
    /**
     * Set malicious flag to enable blackhole behavior.
     * \param f enable flag
     */
    void SetMalicious(bool f);

    /**
     * Get malicious flag value.
     * \returns true if node acts as blackhole
     */
  ...
  private:
    ...
    bool m_isMalicious;      ///< Enables simple blackhole behavior when true
