 ...
 * \ingroup aodvtrust
 *
 * \brief AODVTRUST loopback UDP echo test case
 */
 ...
 *
 * \brief AODVTRUST Loopback test suite
 */
class AodvTrustLoopbackTestSuite : public TestSuite
{
  public:
    AodvTrustLoopbackTestSuite()
        : TestSuite("routing-aodv-trust-loopback", SYSTEM)
    {
        SetDataDir(NS_TEST_SOURCEDIR);
        // UDP Echo loopback test case
        AddTestCase(new LoopbackTestCase(), TestCase::QUICK);
    }
} g_aodvtrustLoopbackTestSuite; ///< the test suite
