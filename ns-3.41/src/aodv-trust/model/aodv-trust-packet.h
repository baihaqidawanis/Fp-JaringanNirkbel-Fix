 ...
 */
#ifndef AODVTRUSTPACKET_H
#define AODVTRUSTPACKET_H
...
enum MessageType
{
    AODVTRUSTTYPE_RREQ = 1,    //!< AODVTRUSTTYPE_RREQ
    AODVTRUSTTYPE_RREP = 2,    //!< AODVTRUSTTYPE_RREP
    AODVTRUSTTYPE_RERR = 3,    //!< AODVTRUSTTYPE_RERR
    AODVTRUSTTYPE_RREP_ACK = 4 //!< AODVTRUSTTYPE_RREP_ACK
};

/**
 * \ingroup aodvtrust
 * \brief AODVTRUST types
 */
class TypeHeader : public Header
{
  public:
    /**
     * constructor
     * \param t the AODVTRUST RREQ type
     */
    TypeHeader(MessageType t = AODVTRUSTTYPE_RREQ);
