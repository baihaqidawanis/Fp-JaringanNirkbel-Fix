 ...
 */
#ifndef AODVTRUST_RQUEUE_H
#define AODVTRUST_RQUEUE_H
...
/**
 * \ingroup aodvtrust
 * \brief AODVTRUST route request queue
 *
 * Since AODVTRUST is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
  public:
