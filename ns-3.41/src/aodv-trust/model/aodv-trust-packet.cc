...
{
    static TypeId tid = TypeId("ns3::aodvtrust::TypeHeader")
                            .SetParent<Header>()
...
{
    static TypeId tid = TypeId("ns3::aodvtrust::RreqHeader")
                            .SetParent<Header>()
                            .SetGroupName("AodvTrust")
...
{
    static TypeId tid = TypeId("ns3::aodvtrust::RrepHeader")
                            .SetParent<Header>()
                            .SetGroupName("AodvTrust")
...
{
    static TypeId tid = TypeId("ns3::aodvtrust::RrepAckHeader")
                            .SetParent<Header>()
                            .SetGroupName("AodvTrust")
...
{
    static TypeId tid = TypeId("ns3::aodvtrust::RerrHeader")
                            .SetParent<Header>()
                            .SetGroupName("AodvTrust")
